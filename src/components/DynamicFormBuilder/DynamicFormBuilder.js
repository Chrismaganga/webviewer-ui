...
const FORM_TEMPLATES = {
  RESUME_PROFESSIONAL: 'resume_professional',
  RESUME_CREATIVE: 'resume_creative',
  RESUME_EXECUTIVE: 'resume_executive',
  RESUME_ENTRY_LEVEL: 'resume_entry_level',
  RESUME_TECHNICAL: 'resume_technical',
  COVER_LETTER_PROFESSIONAL: 'cover_letter_professional',
  COVER_LETTER_CREATIVE: 'cover_letter_creative',
  COVER_LETTER_EXECUTIVE: 'cover_letter_executive',
...
const DynamicFormBuilder = ({ isOpen, onClose }) => {
  ...
  const [selectedTemplate, setSelectedTemplate] = useState(FORM_TEMPLATES.RESUME_PROFESSIONAL);
  ...
  const templates = {
    [FORM_TEMPLATES.RESUME_PROFESSIONAL]: {
    ...
    [FORM_TEMPLATES.COVER_LETTER_PROFESSIONAL]: {
      title: 'Cover Letter',
    ...
    [FORM_TEMPLATES.RESUME_CREATIVE]: {
      title: 'Creative Resume',
      description: 'Modern creative resume template for design, marketing, and creative industries',
      fields: [
        {
          id: 'fullName',
          label: 'Full Name',
        ...
        },
        {
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: true,
          placeholder: 'Describe your creative vision, style, and what makes you unique',
          validation: 'required|min:50',
        },
        {
          id: 'experience',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: true,
          placeholder: 'List your creative work experience with projects and achievements',
          validation: 'required|min:100',
        },
        {
          id: 'education',
        ...
        },
        {
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: false,
          placeholder: 'List your technical skills (software, tools, etc.)',
        },
        {
          id: 'creativeSkills',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: false,
          placeholder: 'List your creative skills (design styles, techniques, etc.)',
        },
        {
          id: 'projects',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: false,
          placeholder: 'Highlight your best creative projects with descriptions',
        },
        {
          id: 'awards',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: false,
          placeholder: 'List any awards, competitions, or recognition',
        },
        {
          id: 'interests',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: false,
          placeholder: 'Share your creative interests and inspirations',
        },
      ],
    },
    [FORM_TEMPLATES.RESUME_EXECUTIVE]: {
      title: 'Executive Resume',
      description: 'Senior-level resume template for executives and C-level positions',
      fields: [
        {
          id: 'fullName',
          label: 'Full Name',
        ...
        },
        {
          ...
          type: FIELD_TYPES.TEXT,
          required: true,
          placeholder: 'e.g., Chief Executive Officer, Senior Vice President',
          validation: 'required|min:2',
        },
        {
          id: 'email',
        ...
        },
        {
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: true,
          placeholder: 'High-level summary of your executive experience and leadership achievements',
          validation: 'required|min:100',
        },
        {
          id: 'coreCompetencies',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: true,
          placeholder: 'List your key executive competencies and leadership skills',
          validation: 'required|min:50',
        },
        {
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: true,
          placeholder: 'Detail your executive experience with company names, titles, dates, and key achievements',
          validation: 'required|min:200',
        },
        {
          id: 'leadership',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: true,
          placeholder: 'Highlight your leadership accomplishments and strategic initiatives',
          validation: 'required|min:100',
        },
        {
          id: 'education',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: true,
          placeholder: 'List your educational background including advanced degrees',
          validation: 'required|min:50',
        },
        {
          id: 'boardExperience',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: false,
          placeholder: 'List any board memberships or advisory roles',
        },
        {
          id: 'publications',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: false,
          placeholder: 'List any publications, speaking engagements, or thought leadership',
        },
        {
          id: 'awards',
          label: 'Awards & Recognition',
          type: FIELD_TYPES.TEXTAREA,
          required: false,
          placeholder: 'List industry awards, recognition, or honors',
        },
        {
          id: 'community',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: false,
          placeholder: 'List community involvement and philanthropic activities',
        },
      ],
    },
    [FORM_TEMPLATES.RESUME_ENTRY_LEVEL]: {
      title: 'Entry-Level Resume',
      description: 'Resume template for recent graduates and entry-level positions',
      fields: [
        {
          id: 'fullName',
          label: 'Full Name',
        ...
        },
        {
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: true,
          placeholder: 'Brief statement about your career goals and what you hope to achieve',
          validation: 'required|min:50',
        },
        {
          id: 'education',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: true,
          placeholder: 'List your educational background including GPA, relevant coursework, and graduation date',
          validation: 'required|min:50',
        },
        {
          id: 'experience',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: false,
          placeholder: 'List any internships, part-time jobs, or relevant work experience',
        },
        {
          id: 'volunteer',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: false,
          placeholder: 'List any volunteer work or community service',
        },
        {
          id: 'projects',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: false,
          placeholder: 'Highlight relevant academic projects, research, or coursework',
        },
        {
          id: 'skills',
          label: 'Skills',
        ...
        },
        {
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: false,
          placeholder: 'List campus activities, clubs, or leadership roles',
        },
        {
          id: 'certifications',
          label: 'Certifications',
    ...
    [FORM_TEMPLATES.RESUME_TECHNICAL]: {
      title: 'Technical Resume',
      description: 'Resume template for software engineers, developers, and technical professionals',
      fields: [
        {
          id: 'fullName',
          label: 'Full Name',
        ...
        },
        {
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: true,
          placeholder: 'Brief summary of your technical expertise and career objectives',
          validation: 'required|min:50',
        },
        {
          id: 'experience',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: true,
          placeholder: 'List your technical work experience with technologies used and achievements',
          validation: 'required|min:100',
        },
        {
          id: 'education',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: true,
          placeholder: 'List your educational background including relevant coursework',
          validation: 'required|min:50',
        },
        {
          id: 'technicalSkills',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: true,
          placeholder: 'List programming languages, frameworks, tools, and technologies',
          validation: 'required|min:50',
        },
        {
          id: 'projects',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: false,
          placeholder: 'Highlight key technical projects with technologies used and outcomes',
        },
        {
          id: 'certifications',
          label: 'Certifications',
          type: FIELD_TYPES.TEXTAREA,
          required: false,
          placeholder: 'List technical certifications (AWS, Azure, etc.)',
        },
        {
          id: 'openSource',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: false,
          placeholder: 'List any open source contributions or projects',
        },
        {
          id: 'publications',
          ...
          type: FIELD_TYPES.TEXTAREA,
          required: false,
          placeholder: 'List any technical publications, patents, or research papers',
        },
      ],
    },
    [FORM_TEMPLATES.COVER_LETTER_CREATIVE]: {
      title: 'Creative Cover Letter',
      description: 'Creative cover letter template for design, marketing, and creative industries',
      fields: [
        {
          id: 'fullName',
          label: 'Full Name',
        ...
        {
          id: 'creativeIntroduction',
          label: 'Creative Introduction',
          type: FIELD_TYPES.TEXTAREA,
          required: true,
          placeholder: 'Creative opening that showcases your personality and passion for the role',
          validation: 'required|min:100',
        },
        {
          id: 'creativeBody',
          ...
          required: true,
          placeholder:
            'Main content highlighting your creative process, projects, and why you are perfect for this creative role',
          validation: 'required|min:200',
        },
        {
          id: 'creativeClosing',
          label: 'Creative Closing',
          type: FIELD_TYPES.TEXTAREA,
          required: true,
          placeholder: 'Enthusiastic closing that shows your excitement for the opportunity',
          validation: 'required|min:50',
        },
        {
          id: 'signature',
    ...
    [FORM_TEMPLATES.COVER_LETTER_EXECUTIVE]: {
      title: 'Executive Cover Letter',
      description: 'Executive-level cover letter template for senior positions',
      fields: [
        {
          id: 'fullName',
          label: 'Full Name',
        ...
        {
          id: 'executiveIntroduction',
          label: 'Executive Introduction',
          type: FIELD_TYPES.TEXTAREA,
          required: true,
          placeholder: 'Professional introduction highlighting your executive experience and interest in the role',
          validation: 'required|min:100',
        },
        {
          id: 'leadershipBody',
          ...
          required: true,
          placeholder:
            'Main content focusing on your leadership achievements, strategic vision, and how you can drive the company forward',
          validation: 'required|min:200',
        },
        {
          id: 'executiveClosing',
          label: 'Executive Closing',
          type: FIELD_TYPES.TEXTAREA,
          required: true,
          placeholder: 'Professional closing expressing interest in discussing the opportunity further',
          validation: 'required|min:50',
        },
        {
          id: 'signature',
